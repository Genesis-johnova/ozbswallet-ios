...
class ModalPresenter : Subscriber, Trackable {
    ...
    private func presentSettings() {
        ...
        let sections = ["Wallet", "Manage", "Ozbswallet", "Advanced"]
        var rows = [
            ...
            "Advanced": [
                Setting(title: "Advanced", callback: { [weak self] in
                    ...
                    let advancedSettings = [
                        "Network": [
                            Setting(title: "Ozosbitt Nodes", callback: {
...
//                            })
        ...
        if BRAPIClient.featureEnabled(.earlyAccess) {
            rows["Ozbswallet"]?.insert(Setting(title: S.Settings.earlyAccess, callback: {
                settingsNav.dismiss(animated: true, completion: {
        ...
        rows["Ozbswallet"]?.append( Setting(title: S.Settings.review, callback: {
