...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/ozosbitt-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/ozosbitt-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/ozosbitt-paymentack" && data.count <= 50000 {
